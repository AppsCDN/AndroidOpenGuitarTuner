...
/**
 * This class plays a file and sends float arrays to registered ProcesadorAudio
...
public class AudioGenerator implements Runnable {
	...
	/**
	 * Removes an ProcesadorAudio to the chain of processors and calls processingFinished.
	 * 
	 * @param audioProcessor
